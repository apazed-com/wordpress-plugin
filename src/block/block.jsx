...
const CONF = {
    formSelect: {
        ...
        help: __('If the selection is missing a form, you can sync with apazed.com from the dashboard.', 'apazed'),
        startHelp: __('Looks like we still need to get you connected with apazed.com.', 'apazed'),
    },
    cartCb: {
...
function form_selector_opts() {
    return new Promise(
        function (resolve) {
            apiFetch({path: APIROUTES.forms}).then(function (forms) {
